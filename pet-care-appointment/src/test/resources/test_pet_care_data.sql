...
VALUES
    (3,'Дмитрий Сергеев специализируется на терапии. Имеет 10 лет опыта работы с домашними животными.', 7),
    (4,'Наталья Федорова является экспертом в терапии. Особое внимание уделяет психическому состоянию животных.', 8),
